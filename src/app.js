...
Ammo().then((Ammo) => {
  ...
  // 创建你的信息栏 (AllenIverrui #ececdf loving)
  ...
  function loadRyanText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry("AllenIverrui", {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/Poppins_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('   ALL IZZ WELL ', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    simpleText(-42, 0.01, -30, 'WEBSITE', 3);
    simpleText(61, 0.01, -20, 'PREFERENCE', 3);
